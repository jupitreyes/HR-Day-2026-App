...
export function FinalUnlockScreen({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="space-y-12 py-6 flex flex-col flex-1 animate-in fade-in duration-700">
      ...
      <div className="space-y-8 flex-1 animate-in zoom-in-95 duration-700 delay-300 fill-mode-both flex flex-col justify-center">
        ...
        {error && <p className="text-retro-pink animate-pulse font-mono font-bold text-center bg-retro-pink/10 p-3 border-4 border-retro-pink/30">ACCESS DENIED. INCORRECT FINAL ANSWER.</p>}
      </div>
